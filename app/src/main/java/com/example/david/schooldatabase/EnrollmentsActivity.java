...
public class EnrollmentsActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            getSupportFragmentManager().beginTransaction()
                    .add(R.id.container, new EnrollmentFragment())
                    .commit();
        }
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.enrollmentfragment, menu);
    ...
    public void onClickAddEnrollment(View view) {
        startActivity(new Intent(this, AddEnrollmentActivity.class));
    }
    ...
    private Intent createShareStudentIntent() {
        ...
        shareIntent.putExtra(Intent.EXTRA_TEXT,
                mEnrollmentStr + ENROLLMENT_SHARE_HASHTAG);
        return shareIntent;
    }
}
